...
export async function POST(req: NextRequest) {
  try {
    ...
    const order = await payload.create({
      collection: 'orders',
      data: {
        orderNumber: '', // Will be auto-generated by beforeChange hook
        customer: userId || undefined, // Only set if user is authenticated
        guestEmail: userId ? undefined : shippingAddress.email, // Set guest email if not authenticated
        items: orderItems,
        subtotal,
        shipping,
        total,
